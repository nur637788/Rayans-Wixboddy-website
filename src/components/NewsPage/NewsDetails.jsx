...
function NewsDetails() {
    ...
    return (
        <section className='bg-[#FFFEF2] px-5 md:px-10 lg:px-15 xl:px-20 py-5 mt-25'>
            <div>
                <h2 className='text-2xl md:text-[48px] font-medium py-5'>A Second Home in Dubai: Why Investors Are Turning to Luxury Properties</h2>
                <img src="./images/news/news-hero.png" alt="" className='object-cover w-full' />
                <div className='flex items-center gap-5 space-x-4 mt-3 text-[#637381] text-2xl' >
                    <b>ARTICLES </b>
                    <li className=''>May 29, 2025</li>
                    <li className='uppercase '>12 MIN READ</li>
                </div>
                <p className='text-[#637381] text-2xl py-5'>Unguja. The Revolutionary Government of Zanzibar (SMZ) has secured Sh9 billion for the extensive renovation of dilapidated buildings within Stone Town for the fiscal year 2024/25. The funds have been sponsored by Infinity Group, a real Estate development firm that is also in charge of the renovation of the Old Fort</p>
                <div className='text-[#637381] space-y-4 text-2xl'>
                    <h3 className='text-3xl font-medium text-black'>1. Sustainability and Eco-Friendly Living</h3>
                    ...
                    <h3 className='text-3xl font-medium text-black'>2. Sustainability and Eco-Friendly Living</h3>
                    ...
                    <h3 className='text-3xl font-medium text-black'>3. Sustainability and Eco-Friendly Living</h3>
                    ...
                    <h3 className='text-3xl font-medium text-black'>4. Sustainability and Eco-Friendly Living</h3>
            ...
            <div className='my-10'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-2xl md:text-[48px]'>Related Articles</h2>
                    <Link to='/news'>
                        <button className='bg-black text-sm px-6 py-4 rounded text-white  hover:scale-95 transition-all duration-300 cursor-pointer'>View All Blog →</button>
                    </Link>
                </div>
